...
public class PersistenceUtils {
	 ...
	 */
	public static String getMappedByProperty(Class<?> entityClass,
			Object propertyName) {
	...
	public static <A extends Annotation> A getAnnotationForProperty(
		...
		A annotation = getAnnotationFromField(annotationType, entityClass,
				propertyName);
		if (annotation == null) {
			annotation = getAnnotationFromPropertyGetter(annotationType,
